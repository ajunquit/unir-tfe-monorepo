...
namespace UNIR.TFE.Monorepo.WebApp.Test
{
    public class MultiplicationTest
    {
        ...
        public void Multiplication_ShouldReturn_CorrectProduct_ForGivenOperands(decimal a, decimal b, decimal expected)
        {
            var actual = _sut.Multiplication(a, b);
            Assert.Equal(expected, actual);
        }

        [Fact]
        public void Multiplication_ShouldHandle_MaxAndMin_WithIdentity()
        {
            Assert.Equal(decimal.MaxValue, _sut.Multiplication(decimal.MaxValue, 1));
            Assert.Equal(decimal.MinValue, _sut.Multiplication(decimal.MinValue, 1));
        }

        [Fact]
        public void Multiplication_WithZeroOperands_ShouldReturnZero()
        {
            Assert.Equal(0m, _sut.Multiplication(decimal.MaxValue, 0));
            Assert.Equal(0m, _sut.Multiplication(decimal.MinValue, 0));
            Assert.Equal(0m, _sut.Multiplication(0, decimal.MaxValue));
            Assert.Equal(0m, _sut.Multiplication(0, decimal.MinValue));
        }
        ...
        public void Multiplication_WithSequentialNumbers_ReturnsCorrectResult(decimal a, decimal b, decimal expected)
        {
            var result = _sut.Multiplication(a, b);
        ...
        public void Multiplication_WithDecimalNumbers_ReturnsPreciseProduct(decimal a, decimal b, decimal expected)
        {
            var result = _sut.Multiplication(a, b);
            Assert.Equal(expected, result);
        }
        ...
        public void Multiplication_WithLargeNumbers_ReturnsCorrectResult(decimal a, decimal b, decimal expected)
        {
            var result = _sut.Multiplication(a, b);
            Assert.Equal(expected, result);
        }
        ...
        public void Multiplication_ShouldBeCommutative(decimal a, decimal b)
        {
            var ab = _sut.Multiplication(a, b);
            var ba = _sut.Multiplication(b, a);
            Assert.Equal(ab, ba);
        }
        ...
        public void Multiplication_ShouldBeAssociative(decimal a, decimal b, decimal c)
        {
            var left = _sut.Multiplication(_sut.Multiplication(a, b), c);
            var right = _sut.Multiplication(a, _sut.Multiplication(b, c));
        ...
        public void Multiplication_ShouldBeDistributiveOverAddition(decimal a, decimal b, decimal c)
        {
            var left = _sut.Multiplication(a, b + c);
            var right = _sut.Multiplication(a, b) + _sut.Multiplication(a, c);
            AssertNearlyEqual(left, right, decimals: 18);
        }
        ...
        public void Multiplication_WithOne_ShouldReturnSameNumber(decimal a)
        {
            Assert.Equal(a, _sut.Multiplication(a, 1));
            Assert.Equal(a, _sut.Multiplication(1, a));
        }

        [Theory]
        [MemberData(nameof(IdentityElementTestCases))]
        public void Multiplication_WithZero_ShouldReturnZero(decimal a)
        {
            Assert.Equal(0, _sut.Multiplication(a, 0));
            Assert.Equal(0, _sut.Multiplication(0, a));
        }

        // Rendimiento / repetición
        [Fact]
        public void Multiplication_ShouldHandle_MultipleOperationsCorrectly()
        {
            decimal result = 1;
            decimal expected = 1;
            for (int i = 1; i <= 1000; i++)
            {
                result = _sut.Multiplication(result, -1);
                expected = -expected;
            }
            Assert.Equal(expected, result);
        }
        ...
        public void Multiplication_WithHighPrecisionNumbers_MaintainsPrecision(decimal a, decimal b, decimal expected)
        {
            var result = _sut.Multiplication(a, b);
            Assert.Equal(expected, result);
        }
        ...
        public void Multiplication_BulkRandomizedDataset_ReturnsCorrectProduct(decimal a, decimal b, decimal expected)
        {
            var result = _sut.Multiplication(a, b);
            Assert.Equal(expected, result);
        }
